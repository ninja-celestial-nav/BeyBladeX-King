...
export const RATCHETS = [
  { id: 'r-0-60', name: '0-60', nameCN: '零突起-60高', code: 'R 0-60', protrusions: 0, height: 60, tier: 'T2' },
  { id: 'r-0-70', name: '0-70', nameCN: '零突起-70高', code: 'R 0-70', protrusions: 0, height: 70, tier: 'T2' },
  { id: 'r-0-80', name: '0-80', nameCN: '零突起-80高', code: 'R 0-80', protrusions: 0, height: 80, tier: 'T2' },
  { id: 'r-1-50', name: '1-50', nameCN: '單突起-50高', code: 'R 1-50', protrusions: 1, height: 50, tier: 'T2' },
  { id: 'r-1-60', name: '1-60', nameCN: '單突起-60高', code: 'R 1-60', protrusions: 1, height: 60, tier: 'T0' },
  { id: 'r-1-70', name: '1-70', nameCN: '單突起-70高', code: 'R 1-70', protrusions: 1, height: 70, tier: 'T0' },
  { id: 'r-1-80', name: '1-80', nameCN: '單突起-80高', code: 'R 1-80', protrusions: 1, height: 80, tier: 'T2' },
  { id: 'r-2-60', name: '2-60', nameCN: '雙突起-60高', code: 'R 2-60', protrusions: 2, height: 60, tier: 'T1' },
  { id: 'r-2-70', name: '2-70', nameCN: '雙突起-70高', code: 'R 2-70', protrusions: 2, height: 70, tier: 'T2' },
  { id: 'r-2-80', name: '2-80', nameCN: '雙突起-80高', code: 'R 2-80', protrusions: 2, height: 80, tier: 'T2' },
  { id: 'r-3-60', name: '3-60', nameCN: '三突起-60高', code: 'R 3-60', protrusions: 3, height: 60, tier: 'T0.5' },
  { id: 'r-3-70', name: '3-70', nameCN: '三突起-70高', code: 'R 3-70', protrusions: 3, height: 70, tier: 'T2' },
  { id: 'r-3-80', name: '3-80', nameCN: '三突起-80高', code: 'R 3-80', protrusions: 3, height: 80, tier: 'T2' },
  { id: 'r-3-85', name: '3-85', nameCN: '三突起-85高', code: 'R 3-85 (O型)', protrusions: 3, height: 85, tier: 'T2' },
  { id: 'r-4-50', name: '4-50', nameCN: '四突起-50高', code: 'R 4-50', protrusions: 4, height: 50, tier: 'T0' },
  { id: 'r-4-55', name: '4-55', nameCN: '四突起-55高', code: 'R 4-55 (O型)', protrusions: 4, height: 55, tier: 'T2' },
  { id: 'r-4-60', name: '4-60', nameCN: '四突起-60高', code: 'R 4-60', protrusions: 4, height: 60, tier: 'T1' },
  { id: 'r-4-70', name: '4-70', nameCN: '四突起-70高', code: 'R 4-70', protrusions: 4, height: 70, tier: 'T2' },
  { id: 'r-4-80', name: '4-80', nameCN: '四突起-80高', code: 'R 4-80', protrusions: 4, height: 80, tier: 'T2' },
  { id: 'r-5-60', name: '5-60', nameCN: '五突起-60高', code: 'R 5-60', protrusions: 5, height: 60, tier: 'T0.5' },
  { id: 'r-5-70', name: '5-70', nameCN: '五突起-70高', code: 'R 5-70', protrusions: 5, height: 70, tier: 'T2' },
  { id: 'r-5-80', name: '5-80', nameCN: '五突起-80高', code: 'R 5-80', protrusions: 5, height: 80, tier: 'T2' },
  { id: 'r-6-60', name: '6-60', nameCN: '六突起-60高', code: 'R 6-60', protrusions: 6, height: 60, tier: 'T2' },
  { id: 'r-6-70', name: '6-70', nameCN: '六突起-70高', code: 'R 6-70', protrusions: 6, height: 70, tier: 'T2' },
  { id: 'r-6-80', name: '6-80', nameCN: '六突起-80高', code: 'R 6-80', protrusions: 6, height: 80, tier: 'T2' },
  { id: 'r-7-55', name: '7-55', nameCN: '七突起-55高', code: 'R 7-55 (O型)', protrusions: 7, height: 55, tier: 'T2' },
  { id: 'r-7-60', name: '7-60', nameCN: '七突起-60高', code: 'R 7-60', protrusions: 7, height: 60, tier: 'T0.5' },
  { id: 'r-7-70', name: '7-70', nameCN: '七突起-70高', code: 'R 7-70', protrusions: 7, height: 70, tier: 'T1' },
  { id: 'r-7-80', name: '7-80', nameCN: '七突起-80高', code: 'R 7-80', protrusions: 7, height: 80, tier: 'T2' },
  { id: 'r-8-70', name: '8-70', nameCN: '八突起-70高', code: 'R 8-70', protrusions: 8, height: 70, tier: 'T2' },
  { id: 'r-9-60', name: '9-60', nameCN: '九突起-60高', code: 'R 9-60', protrusions: 9, height: 60, tier: 'T0' },
  { id: 'r-9-65', name: '9-65', nameCN: '九突起-65高', code: 'R 9-65 (O型)', protrusions: 9, height: 65, tier: 'T2' },
  { id: 'r-9-70', name: '9-70', nameCN: '九突起-70高', code: 'R 9-70', protrusions: 9, height: 70, tier: 'T1' },
  { id: 'r-9-80', name: '9-80', nameCN: '九突起-80高', code: 'R 9-80', protrusions: 9, height: 80, tier: 'T2' },
  { id: 'r-m-85', name: 'M-85', nameCN: '融合型-85高', code: 'R M-85 (融合)', protrusions: 0, height: 85, tier: 'T2' },
];
...
export const CX_LOCK_CHIPS = [
  { id: 'lc-bahamut', name: 'Bahamut', nameCN: '巴哈姆特', code: 'LC-Ba', tier: 'T2' },
  { id: 'lc-cerberus', name: 'Cerberus', nameCN: '地獄犬', code: 'LC-Ce', tier: 'T2' },
  { id: 'lc-dran', name: 'Dran', nameCN: '龍', code: 'LC-Dr', tier: 'T2' },
  { id: 'lc-emperor', name: 'Emperor', nameCN: '帝王', code: 'LC-Em', tier: 'T2' },
  { id: 'lc-eva', name: 'Eva', nameCN: '伊娃', code: 'LC-Ev', tier: 'T2' },
  { id: 'lc-fox', name: 'Fox', nameCN: '狐狸', code: 'LC-Fo', tier: 'T2' },
  { id: 'lc-hells', name: 'Hells', nameCN: '地獄', code: 'LC-He', tier: 'T2' },
  { id: 'lc-hornet', name: 'Hornet', nameCN: '黃蜂', code: 'LC-Ho', tier: 'T2' },
  { id: 'lc-knight', name: 'Knight', nameCN: '騎士', code: 'LC-Kn', tier: 'T2' },
  { id: 'lc-kraken', name: 'Kraken', nameCN: '海妖', code: 'LC-Kr', tier: 'T2' },
  { id: 'lc-leon', name: 'Leon', nameCN: '獅子', code: 'LC-Le', tier: 'T2' },
  { id: 'lc-pegasus', name: 'Pegasus', nameCN: '天馬', code: 'LC-Pe', tier: 'T1' },
  { id: 'lc-perseus', name: 'Perseus', nameCN: '柏修斯', code: 'LC-Ps', tier: 'T2' },
  { id: 'lc-phoenix', name: 'Phoenix', nameCN: '鳳凰', code: 'LC-Ph', tier: 'T2' },
  { id: 'lc-ragna', name: 'Ragna', nameCN: '諸神黃昏', code: 'LC-Ra', tier: 'T2' },
  { id: 'lc-rhino', name: 'Rhino', nameCN: '犀牛', code: 'LC-Rh', tier: 'T2' },
  { id: 'lc-sol', name: 'Sol', nameCN: '太陽', code: 'LC-So', tier: 'T2' },
  { id: 'lc-stag', name: 'Stag', nameCN: '鍬形蟲', code: 'LC-St', tier: 'T2' },
  { id: 'lc-unicorn', name: 'Unicorn', nameCN: '獨角獸', code: 'LC-Un', tier: 'T2' },
  { id: 'lc-valkyrie', name: 'Valkyrie', nameCN: '女武神', code: 'LC-Va', tier: 'T2' },
  { id: 'lc-whale', name: 'Whale', nameCN: '鯨魚', code: 'LC-Wh', tier: 'T2' },
  { id: 'lc-wizard', name: 'Wizard', nameCN: '魔術師', code: 'LC-Wi', tier: 'T1' },
  { id: 'lc-wolf', name: 'Wolf', nameCN: '狼', code: 'LC-Wo', tier: 'T2' },
];

export const CX_MAIN_BLADES = [
  { id: 'mb-blast', name: 'Blast', nameCN: '爆裂', code: 'MB-Bl', tier: 'T0' },
  { id: 'mb-might', name: 'Might', nameCN: '威力', code: 'MB-Mi', tier: 'T1' },
  { id: 'mb-reaper', name: 'Reaper', nameCN: '死神', code: 'MB-Re', tier: 'T1' },
  { id: 'mb-antler', name: 'Antler', nameCN: '鹿角', code: 'MB-An', tier: 'T2' },
  { id: 'mb-arc', name: 'Arc', nameCN: '弧', code: 'MB-Ar', tier: 'T2' },
  { id: 'mb-brave', name: 'Brave', nameCN: '勇者', code: 'MB-Br', tier: 'T2' },
  { id: 'mb-brush', name: 'Brush', nameCN: '刷', code: 'MB-Bu', tier: 'T3' },
  { id: 'mb-dark', name: 'Dark', nameCN: '暗黑', code: 'MB-Da', tier: 'T2' },
  { id: 'mb-eclipse', name: 'Eclipse', nameCN: '月蝕', code: 'MB-Ec', tier: 'T2' },
  { id: 'mb-fang', name: 'Fang', nameCN: '獠牙', code: 'MB-Fa', tier: 'T2' },
  { id: 'mb-flame', name: 'Flame', nameCN: '火焰', code: 'MB-Fl', tier: 'T2' },
  { id: 'mb-flare', name: 'Flare', nameCN: '閃焰', code: 'MB-Fr', tier: 'T2' },
  { id: 'mb-fort', name: 'Fort', nameCN: '要塞', code: 'MB-Fo', tier: 'T2' },
  { id: 'mb-hunt', name: 'Hunt', nameCN: '狩獵', code: 'MB-Hu', tier: 'T2' },
  { id: 'mb-volt', name: 'Volt', nameCN: '伏特', code: 'MB-Vo', tier: 'T2' },
  { id: 'mb-wriggle', name: 'Wriggle', nameCN: '蠕動', code: 'MB-Wr', tier: 'T3' },
];
